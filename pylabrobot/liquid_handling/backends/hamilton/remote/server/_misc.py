...
class MiscServerMixin:
    ...
    async def halt(
        self, request: pb2.HaltRequest, ctx: RequestContext
    ) -> pb2.HaltResponse:
    ...
    async def move_left_x_arm_to_position_with_all_attached_components_in_z_safety_position(
        ...
        await self._backend.move_left_x_arm_to_position_with_all_attached_components_in_z_safety_position(
    ...
    async def move_right_x_arm_to_position_with_all_attached_components_in_z_safety_position(
        ...
        await self._backend.move_right_x_arm_to_position_with_all_attached_components_in_z_safety_position(
            x_position=request.x_position,
        )
